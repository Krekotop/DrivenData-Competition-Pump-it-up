...
model_3 = Pipeline([
        ('preprocessor', preprocessor),
        ('classifier', ExtraTreesClassifier(n_estimators = 150))
        ])
model_1 = Pipeline([
        ('preprocessor', preprocessor),
...
voting_clf = VotingClassifier(
        estimators = [('rf', model_4), ('xgb', model_7), ('knc', model_1), #('rc', model_2),
                      ('etc',model_3),('ada', model_8),('gb', model_5)],voting = 'soft')
