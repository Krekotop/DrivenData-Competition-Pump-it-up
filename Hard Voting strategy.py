# -*- coding: utf-8 -*-
"""
Created on Fri Apr 17 16:27:32 2020
Try out different strategy - Voting Classifer based on output of couple of models 
"""
...
voting_clf = VotingClassifier(
        estimators = [('rf', model_4), ('xgb', model_7),('dtc',model_3)], voting = 'hard')
voting_clf.fit(X_train,y_train)
voting_clf_score = voting_clf.score(X_train,y_train)


make_submission(voting_clf,X_test)
